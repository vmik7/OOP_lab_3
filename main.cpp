...
public:
	...
	// Изменение координат
	int set_x(int value) { this->x = value; }
	int set_y(int value) { this->y = value; }
	int set_z(int value) { this->z = value; }
...
int main() {
	...
	cout << "Введите конечные точки первого вектора: " << endl;
	...
	cout << "Введите конечные точки второго вектора: " << endl;
